...
from munshi_docproc.schema import FigureRecord, PageRecord, TextBlockRecord
from munshi_docproc.utils.io import ensure_dir, read_jsonl
...
def generate_report(
    ...
    if pdf_path is None:
        from munshi_docproc.schema import DocumentRecord
    ...
    # Render template
    try:
        env = Environment(loader=PackageLoader("munshi_docproc", "templates"))
    except Exception:
