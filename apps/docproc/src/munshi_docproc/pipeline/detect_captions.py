...
from munshi_docproc.pipeline.extract_mupdf import MuPDFPageData, SpanInfo
from munshi_docproc.schema import BBox, FigureRecord, PlateRecord, TextBlockRecord
...
def _find_caption_from_blocks(
    ...
    """
    from munshi_docproc.utils.geometry import vertical_distance
