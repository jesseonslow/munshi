...
from munshi_docproc.pipeline.classify_doctype import VALID_DOCUMENT_TYPES
...
def enrich_metadata_llm(
    ...
    try:
        ...
        client = OpenAI(
            ...
            default_headers={"HTTP-Referer": "https://github.com/munshi-docproc", "X-Title": "munshi-docproc"},
        )
        resp = client.chat.completions.create(
            model=config.openrouter_reasoning_model_id,
            messages=[
        ...
        # Strip <think>...</think> blocks and code fences
