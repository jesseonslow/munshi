...
from munshi_docproc.schema import BBox, DocumentRecord, MetadataSource, TextBlockRecord
...
class TestEnrichMetadataLLM:
    ...
    def test_applies_llm_results_to_empty_fields(self):
        from munshi_docproc.pipeline.enrich_metadata_llm import _apply_llm_result
...
class TestEnrichMetadataWeb:
    ...
    @patch("munshi_docproc.pipeline.enrich_metadata_web._http_get_json")
    def test_crossref_enrichment(self, mock_get_json):
        from munshi_docproc.pipeline.enrich_metadata_web import _enrich_from_crossref
    ...
    def test_openlibrary_enrichment(self, mock_get_json):
        from munshi_docproc.pipeline.enrich_metadata_web import _enrich_from_openlibrary
    ...
    def test_duckduckgo_enrichment(self, mock_get_json):
        from munshi_docproc.pipeline.enrich_metadata_web import _enrich_from_duckduckgo
